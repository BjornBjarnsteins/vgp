...
function Rock() {
	...
	console.log("generating rock at: (" + this.cx + "," + this.cy + ")");
	...
	var direction = util.randRange(0, 2*Math.PI);

    this.velX = speed*Math.cos(direction)/SECS_TO_NOMINALS;
    this.velY = speed*Math.sin(direction)/SECS_TO_NOMINALS;

	console.log("setting rock velocity to: (" + this.velX + "," + this.velY + ")");


    var MIN_ROT_SPEED = 0.5/SECS_TO_NOMINALS,
        MAX_ROT_SPEED = 2.5/SECS_TO_NOMINALS;
